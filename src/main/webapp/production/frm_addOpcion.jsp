...
<!--                                         <span class="section">Personal Info</span> -->
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                            	<input class="form-control"   name="nombre" id="nombre" placeholder="Nombre de la opcion" required="required" />
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                            	<input class="form-control" name="descripcion" id="descripcion" placeholder="Descripcion de la opcion" required="required" />
