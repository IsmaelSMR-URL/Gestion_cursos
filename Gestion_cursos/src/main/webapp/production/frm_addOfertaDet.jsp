...
<!--                                         <span class="section">Personal Info</span> -->
                                        ...
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Fecha Inicio <span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                            	<input  class="form-control" type="date" name="finiciod" id="finiciod" placeholder="ex. Primer Semestre 2020" required="required" />
                                        ...
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Fecha Final <span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                            	<input  class="form-control" type="date" name="ffinald" id="ffinald" placeholder="ex. Primer Semestre 2020" required="required" />
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                            	<input  class="form-control" name="hinicio" id="hinicio" placeholder="ex. 1S2020" required="required" />
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                            	<input  class="form-control"  name="hfinal" id="hfinal" placeholder="ex. ofertas dentro del periodo 1S 2020" required="required" />
