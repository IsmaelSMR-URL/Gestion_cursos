...
<head>
    ...
    <title>Gestion de Usuarios | Usuario </title>
...
<!--                                         <span class="section">Personal Info</span> -->
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                            	<input class="form-control" data-validate-length-range="6" data-validate-words="2" name="userName" placeholder="ex. John f. Kennedy" required="required" />
										</div>
										</div>
										 ...
										 <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                            	<input class="form-control" data-validate-length-range="6" data-validate-words="2" name="gender" placeholder="ex. John f. Kennedy" required="required" />
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                            	<input class="form-control" data-validate-length-range="6" data-validate-words="2" name="email" placeholder="ex. John f. Kennedy" required="required" />
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                            	<input class="form-control" data-validate-length-range="6" data-validate-words="2" name="Insemail" placeholder="ex. John f. Kennedy" required="required" />
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                            	<input class="form-control" data-validate-length-range="6" data-validate-words="2" name="telephone" placeholder="ex. John f. Kennedy" required="required" />
                                  ...
                                  <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                            	<input class="form-control" data-validate-length-range="6" data-validate-words="2" name="charge" placeholder="ex. John f. Kennedy" required="required" />
									   </div>
                                       </div>
