...
<!--                                         <span class="section">Personal Info</span> -->
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                            	<input readonly class="form-control" name="clasificacion" id="name" placeholder="ex. A" />
                                          ...
                                          <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                            	<input readonly class="form-control" name="clasificacion" id="userName" placeholder="ex. A" />
                                          ...
                                          <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                            	<input readonly class="form-control" name="clasificacion" id="persEmail" placeholder="ex. A" />
                                          ...
                                          <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                            	<input readonly class="form-control" name="clasificacion" id="insEmail" placeholder="ex. A" />
                                         ...
                                         <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                            	<input readonly class="form-control" name="clasificacion" id="regDate" placeholder="ex. A" />
