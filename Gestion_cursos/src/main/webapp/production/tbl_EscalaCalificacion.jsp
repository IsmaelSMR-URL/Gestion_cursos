...
<html>
  <head>
    ...
    <title>Gestión | Escala de Calificaciones</title>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              ...
              <span>Gestión de cursos de formación docente</span></a>
            </div>
          ...
          <div class="">
            ...
            <div class="clearfix"></div>
              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Registro de Escala de Calificaciones</h2>
                      ...
                      <div class="row">
                          <div class="col-sm-12">
                            ...
                            <div class="text-muted font-13 col-md-12"
								...
								<a href="frm_addEscalaCalificacion.jsp"> <i class="fa fa-2x fa-plus-square" title="Nuevas Escala de Calificaciones"></i></a>
								<br></br>
							</div>
