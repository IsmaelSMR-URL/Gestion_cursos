...
//	private static String url = "jdbc:mysql://localhost:3306/flesnic?useSSL=false&useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
	private static String url = "jdbc:mysql://165.98.12.158:3306/gc_mcgofe?autoReconnect=true&useSSL=false&serverTimezone=UTC";
	...
	public static void main(String[] args) throws SQLException 
	{
        ...
        finally
        {
            ...
            {
               con.close();
               System.out.println("Se desconecto de flesnic!!!");
            } 
